  ...
  $.fn.vimeo = function() {
    return this.each(function() {
      ...
      $select = function() {
        ...
        //Prune the data
        $itemdata.hd = $itemdata.hd.split('&oauth2_token_id')[0]+'&filler=0000000000000000000000000000';
        $itemdata.sd = $itemdata.sd.split('&oauth2_token_id')[0]+'&filler=0000000000000000000000000000';
        //Update the value
